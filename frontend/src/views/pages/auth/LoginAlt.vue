    ...
    <div class="min-h-screen bg-surface-50 dark:bg-surface-950 flex">
        ...
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="space-y-6">
                    <div>
                        <h1 class="text-3xl font-bold text-surface-900 dark:text-surface-0 mb-2">Login</h1>
                        <p class="text-surface-600 dark:text-surface-400">Please enter your details</p>
                    </div>

                    <!-- Social Login Buttons -->
                    <div class="space-y-3">
                        <Button 
                            severity="secondary" variant="outlined"class="w-full h-12">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <Checkbox v-model="checked" id="remember" binary class="mr-2" />
                                <label for="remember" class="text-sm text-surface-700 dark:text-surface-300">Remember me</label>
                            </div>
                            <a href="#" class="text-sm text-primary hover:underline">Forgot password?</a>
                        </div>

                        <Button label="Login" class="w-full h-12" as="router-link" to="/" />
