                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div class="relative mb-6">
                        <div class="absolute inset-0 flex items-center">
                            <div class="w-full md:w-[30rem] border-t border-surface-300 dark:border-surface-600"></div>
                        </div>
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-surface-0 dark:bg-surface-900 text-surface-500 dark:text-surface-400">or</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            <div class="flex items-center">
                                ...
                                <label for="rememberme1" class="text-sm text-surface-700 dark:text-surface-300">Remember me</label>
                            </div>
