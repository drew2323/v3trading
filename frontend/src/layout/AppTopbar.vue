            ...
            <div class="layout-topbar-menu">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="relative">
                        ...
                        <div class="layout-topbar-menu-dropdown hidden">
                            <div class="layout-topbar-menu-dropdown-content">
                                <template v-if="isAuthenticated">
                                    <div class="px-4 py-3 border-b">
                                        <p class="text-sm font-semibold">{{ user?.name }}</p>
                                        <p class="text-xs text-gray-500">{{ user?.email }}</p>
                                    </div>
                                    <button type="button" class="layout-topbar-dropdown-item">
                                        <i class="pi pi-user"></i>
                                    ...
                                    <button @click="handleLogout" type="button" class="layout-topbar-dropdown-item text-red-500">
                                        <i class="pi pi-sign-out"></i>
                                        <span>Log out</span>
                                    </button>
                                </template>
                                <template v-else>
                                    <button @click="handleLogin" type="button" class="layout-topbar-dropdown-item">
